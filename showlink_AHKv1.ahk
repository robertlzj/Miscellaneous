;From https://www.autohotkey.com/boards/viewtopic.php?f=83&t=86940&p=405231#p405231
...
ShowPath(path, explorer)
{
	...
	if (explorer)
	{
		...
		Run("explorer.exe /select,`"" HandleSpaceInPath(path) "`"")
		;	always fail - open "document" even in CMD.
	}
}
